...
__attribute__((always_inline)) static void Get_Pixel_yuv(YUV_IMAGE_T * i, int px, int py, YUV_T * yuv);


int Sq_UV_Difference_yuv(YUV_T * c1, YUV_T * c2);
void Draw_Line_SWD(YUV_IMAGE_T * i, PIXEL_HOLDER_T* pixelInfo, YUV_T * color);
